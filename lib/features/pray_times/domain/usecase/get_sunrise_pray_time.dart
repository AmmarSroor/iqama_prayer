...
class GetSunrisePrayTime extends UseCase<PrayTimes,Parameters>{
  final PrayTimesRepository repository;
  GetSunrisePrayTime(this.repository);
  @override
...
class Parameters extends Equatable {
  ...
  Parameters({required this.date,required this.sunrise});

  @override
  List<Object> get props => [date,sunrise];
}