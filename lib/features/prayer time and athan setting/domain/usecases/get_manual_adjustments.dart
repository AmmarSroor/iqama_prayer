...
class GetManualAdjustments extends UseCase<PrayerTimeAndAthanSetting, NoParameters> {
  final PrayerTimeAndAthanSettingRepository repository;

  GetManualAdjustments(this.repository);

  @override
  Future<Either<Failure, PrayerTimeAndAthanSetting>> call(
      NoParameters params) async {
    return await repository.getManualAdjustments();
  }
}
