...
class GetPrePrayerTimeNotifictions extends UseCase<PrayerTimeAndAthanSetting, NoParameters> {
  final PrayerTimeAndAthanSettingRepository repository;

  GetPrePrayerTimeNotifictions(this.repository);

  @override
  Future<Either<Failure, PrayerTimeAndAthanSetting>> call(NoParameters params) async {
    return await repository.getPrePrayerTimeNotifictions();
  }
}