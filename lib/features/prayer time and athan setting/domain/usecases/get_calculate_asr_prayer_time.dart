...
class GetCalculateAsrPrayerTime extends UseCase<PrayerTimeAndAthanSetting, NoParameters> {
  final PrayerTimeAndAthanSettingRepository repository;

  GetCalculateAsrPrayerTime(this.repository);

  @override
  Future<Either<Failure, PrayerTimeAndAthanSetting>> call(NoParameters params) async {
    return await repository.getCalculateAsrPrayerTime();
  }
}